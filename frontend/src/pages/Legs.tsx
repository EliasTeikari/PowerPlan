...
import smithMachineSquat from "../assets/images/legs-images/smith-machine-squat.png";
import legExtension from "../assets/images/legs-images/leg-extension.png";
import seatedLegCurl from "../assets/images/legs-images/seated-leg-curl.png";
import machineHipAdduction from "../assets/images/legs-images/machine-hip-adduction.png";
import dbCalfJump from "../assets/images/legs-images/DB-calf-jump.png";
        ...
        <>
            <div style={{ width: '100%', position: 'relative', minHeight: '100vh' }}>
                ...
                <div style={{ 
                    ...
                    <h1 className="text-white p-3 mt-3 fw-bold d-flex justify-content-center display-1">LEGS WORKOUT</h1>
