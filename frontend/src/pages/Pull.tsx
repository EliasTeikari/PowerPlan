...
import oneArmLat from "../assets/images/pull-images/1ArmLat.png";
import cableRow from "../assets/images/pull-images/cablerow.png";
import n1Curl from "../assets/images/pull-images/N1Curl.png";
import pausedRDL from "../assets/images/pull-images/PausedRDL.png";
import reversePecDeck from "../assets/images/pull-images/ReversePecdeck.png";
import tbarRow from "../assets/images/pull-images/TbarROW.png";
        ...
        <>
            <div style={{ width: '100%', position: 'relative', minHeight: '100vh' }}>
                ...
                <div style={{ 
                    ...
                    <h1 className="text-white p-3 mt-3 fw-bold d-flex justify-content-center display-1">PULL WORKOUT</h1>
