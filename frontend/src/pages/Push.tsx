...
import lowInclineDBPress from "../assets/images/push-images/Low-Incline-DB-Press.png";
import bentOverCablePecFlye from "../assets/images/push-images/Bent-Over-Cable-Pec-Flye.png";
import dbLateralRaise from "../assets/images/push-images/DB-Lateral-Raise.png";
import overheadCableTricepsExtension from "../assets/images/push-images/Overhead-Cable-Triceps-Extension.png";
import closeGripPushUp from "../assets/images/push-images/Close-Grip-Push-Up.png";
import cableCrunch from "../assets/images/push-images/Cable-Crunch.png";
...
const exercises: Exercise[] = [
    ...
    },
    {
        ...
        image: bentOverCablePecFlye,
        warmUpSets: ["Set 1: 50% weight - 12 reps", "Set 2: 70% weight - 8 reps"],
        workingSets: ["Set 1: 8-12 reps", "Set 2: 8-12 reps", "Set 3: 8-12 reps"]
    },
    {
        name: "DB Lateral Raise",
        image: dbLateralRaise,
        warmUpSets: ["Set 1: 50% weight - 12 reps", "Set 2: 70% weight - 8 reps"],
        workingSets: ["Set 1: 8-12 reps", "Set 2: 8-12 reps", "Set 3: 8-12 reps"]
    },
    {
        name: "Overhead Cable Triceps Extension",
        image: overheadCableTricepsExtension,
        warmUpSets: ["Set 1: 50% weight - 12 reps", "Set 2: 70% weight - 8 reps"],
        workingSets: ["Set 1: 8-12 reps", "Set 2: 8-12 reps", "Set 3: 8-12 reps"]
    },
    {
        ...
        <>
            <div style={{ width: '100%', position: 'relative', minHeight: '100vh' }}>
                ...
                <div style={{ 
                    ...
                    <h1 className="text-white p-3 mt-3 fw-bold d-flex justify-content-center display-1">PUSH WORKOUT</h1>
